...
<?php
 // delete record
	...
	if($_POST['delete_x'] || $_POST['delete'])
	{
		$delQuery = "DELETE FROM $snPurchaseData WHERE randid='".$RandId."'";
 ...
 ?>
              ...
              <div class="modal-footer" style='background:#eaeced;'>
                ...
                <a href='reports-purchase.php' type="button" class="btn btn-ouline" style='font-weight:bold;font-size:14px;background:#045FB4;color:white;'>OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
