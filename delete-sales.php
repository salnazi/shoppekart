...
<?php
 // delete record
	...
	{
		$delQuery = "DELETE FROM $snSales WHERE randid='".$RandId."'";
 ...
 ?>
              ...
              <div class="modal-footer" style='background:#eaeced;'>
                ...
                <a href='reports-sales.php' type="button" class="btn btn-ouline" style='font-weight:bold;font-size:14px;background:#045FB4;color:white;'>OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
