...
<?php
		...
		echo "<table>";
				...
				echo "<tr ><td style ='width:200px;font-weight:bold;'>
              </div>Date</td><td style='color:#036086;font-weight:bold;'>";
echo '<input type="text" name="date" style ="width:100px;" id="datepicker" autocomplete="off">';
				echo "</td></tr>";
				echo "<tr><td style ='width:200px;font-weight:bold;' autocomplete='off'>Details</td><td>";
...
if($_POST['save'] == "SAVE")
{
	if(!empty($_POST['details']) && !empty($_POST['amount']))
	{
		...
		$Query = "INSERT INTO $snInvestment (date,details,amt,randid) VALUES ('$snDate','$snDetails','$snAmount','$snRandid')";
