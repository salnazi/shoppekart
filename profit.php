  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Profit Paid Out  </a></li>
        <li class="active"></li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Profit Paid Out </h3>
            </div>
...
if($_POST['save'] == "SAVE")
{
	if(!empty($_POST['details']) && !empty($_POST['amount']))
	{
		...
		$Query = "INSERT INTO $snProfit (date,details,amt,randid) VALUES ('$snDate','$snDetails','$snAmount','$snRandid')";
