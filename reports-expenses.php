...
<?php
	...
	$Investment = "SELECT * FROM $snExpenses";
...
<tr>
<?php
	$totInvestment = "SELECT SUM(amt) FROM $snExpenses";
	...
	foreach($totsInvest as $totAmt)
	{
		...
		echo "<tr><td></td><td style='text-align:right;color: #B40431;font-weight:bold;'>TOTAL EXPENSES</td><td style='text-align:left;color: #B40431;font-weight:bold;'>".$totAmt."</td></tr>";
	}
?>
</tr>
</tfoot>
