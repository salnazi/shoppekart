  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Investment Report </a></li>
        <li class="active"></li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Investment Report</h3>
            </div>
...
<?php
	...
	$Investment = "SELECT * FROM $snInvestment";
...
<tr>
<?php
	$totInvestment = "SELECT SUM(amt) FROM $snInvestment";
	...
	foreach($totsInvest as $totAmt)
	{
		...
		echo "<tr><td></td><td style='text-align:right;color: #B40431;font-weight:bold;'>TOTAL INVESTMENT</td><td style='text-align:left;color: #B40431;font-weight:bold;'>".$totAmt."</td></tr>";
	}
?>
</tr>
</tfoot>
