...
<tr>
	...
	<th style='color: #B40431;'>SUPPLIER NAME</th>
...
<?php
	...
	$Investment = "SELECT * FROM $snPurchaseData";
...
<tr>
<?php
	$totInvestment = "SELECT SUM(totPrice) as ntotPrice FROM $snPurchaseData";
	...
	echo "<tr><td></td><td></td><td></td><td></td><td></td><td style='text-align:right;color: #B40431;font-weight:bold;'>TOTAL PURCHASE</td><td style='text-align:left;color: #B40431;font-weight:bold;'>".number_format(abs($totAmt),2)."</td><td></td></tr>";
