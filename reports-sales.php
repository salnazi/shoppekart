...
<tr>
	...
	<th style='color: #B40431;'>CUSTOMER NAME</th>
	<th style='color: #B40431;'>CODE</th>
	<th style='color: #B40431;'>DETAILS</th>
	<th style='color: #B40431;'>QTY</th>
	<th style='color: #B40431;'>UNIT PRICE</th>
	<th style='color: #B40431;'>SALES AMT</th>
</tr>
</thead>
<tbody>
...
<?php
	...
	$Investment = "SELECT * FROM $snSales";
	...
	echo '<tr>
			  ...
			  <td>'.$Invest->Qty.'</td>
			  <td>'.$Invest->unitPrice.'</td>
			  <td>'.$Invest->GsalesAmt.'</td>
...
<tr>
<?php
	$totInvestment = "SELECT SUM(GsalesAmt) FROM $snSales";
	...
	foreach($totsInvest as $totAmt)
	{
		...
		echo "<td></td><td></td><td></td><td></td><td></td><td></td><td style='text-align:right;color: #B40431;font-weight:bold;'>TOTAL SALES</td><td style='text-align:left;color:#B40431;font-weight:bold;'>".number_format(abs($totAmt),2)."</td>";
	}
?>
