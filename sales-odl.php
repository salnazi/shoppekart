...
<?php
	...
	echo '<input type="text" name="soldTo" style ="width:500px;" >';
	echo "</td></tr>";
...
?>
<input type="submit" name="save" value="SAVE" style ="width:100px;font-weight:bold;" class="btn btn-primary btn-block btn-flat" onClick="return confirm('Are you sure you want to Save?')" >
<?php
	echo "</td></tr>";
	echo "</table>";
?>
...
<?php
	...
	if($_POST['save'] == "SAVE")
	{
		...
		while($rowChk = mysqli_fetch_object($SCheck))
		{
			...
			else
			{
				...
				/*echo "Grand Sales Qty : " . $SalesQty;
				echo "<br>";
				echo "Grand Sales Amt : " . $SalesTotal;
				echo "<br>";

				echo "Unit Cost : " . $UnitCost;
				echo "<br>";
				*/
